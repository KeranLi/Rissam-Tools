...
# Form implementation generated from reading ui file 'f:\DDE_Ocean_Sediments\Rissam\ui\MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1279, 28))
        font = QtGui.QFont()
        ...
        self.menuMineral_Tools = QtWidgets.QMenu(self.menubar)
        self.menuMineral_Tools.setObjectName("menuMineral_Tools")
        ...
        self.info_dock.setMinimumSize(QtCore.QSize(107, 54))
        ...
        self.annos_dock.setMinimumSize(QtCore.QSize(107, 54))
        ...
        self.plane_plorized_dock = QtWidgets.QDockWidget(MainWindow)
        self.plane_plorized_dock.setObjectName("plane_plorized_dock")
        self.dockWidgetContents_7 = QtWidgets.QWidget()
        self.dockWidgetContents_7.setObjectName("dockWidgetContents_7")
        self.plane_plorized_dock.setWidget(self.dockWidgetContents_7)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(4), self.plane_plorized_dock)
        ...
        self.actionScaleTransfrom = QtWidgets.QAction(MainWindow)
        self.actionScaleTransfrom.setObjectName("actionScaleTransfrom")
        self.actionVizAxis = QtWidgets.QAction(MainWindow)
        self.actionVizAxis.setObjectName("actionVizAxis")
        self.actionv = QtWidgets.QAction(MainWindow)
        self.actionv.setObjectName("actionv")
        self.actionVisualize_Annotation_in_Colors = QtWidgets.QAction(MainWindow)
        self.actionVisualize_Annotation_in_Colors.setObjectName("actionVisualize_Annotation_in_Colors")
        ...
        self.menuMineral_Tools.addAction(self.actionScaleTransfrom)
        self.menuMineral_Tools.addAction(self.actionVizAxis)
        self.menuMineral_Tools.addAction(self.actionv)
        self.menuMineral_Tools.addAction(self.actionVisualize_Annotation_in_Colors)
        ...
        self.menubar.addAction(self.menuMineral_Tools.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Rissam Tools: River Sand Segment Anything Model Tools"))
        ...
        self.menuMineral_Tools.setTitle(_translate("MainWindow", "Mineral Tools"))
        ...
        self.actionScaleTransfrom.setText(_translate("MainWindow", "Scale Transform"))
        self.actionVizAxis.setText(_translate("MainWindow", "Visualize  Axis"))
        self.actionv.setText(_translate("MainWindow", "Visualize Annotation in Black and White"))
        self.actionVisualize_Annotation_in_Colors.setText(_translate("MainWindow", "Visualize Annotation in Colors"))
import icons_rc
